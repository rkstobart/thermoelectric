...
M=2;% N is the numner of TEMs in a CV
side=2;% side is the number of heat exchanger channel
B=0.45*0.16/5;% B is the area of a CV m2

%% Hot side heat exchanger parameters
M_hxr=0.16128*3;% M_hxr is the mass of the hot side heat exchanger, kg
C_hxr=500;% C_hxr is the heat capacity of the hot side heat exchanger,  J/(kg,K)
M_ap=0.024066*3;% M_ap is the mass of the aluminate plate, kg
C_ap=900;% C_ap is the heat capacity of the aluminate plate,  J/(kg,K)
l_hxr=0.45/6; % Length of the channel [m]
b_hxr=0.16; % Width of the channel [m]
...
M_cxr=1.5045*3;% M_cxr is the mass of the cold side heat exchanger, kg
